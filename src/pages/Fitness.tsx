...
const Fitness = () => {
  ...
  const exercises = [
    { name: 'Sklekovi', sets: 3, reps: '10-15', description: 'Postavite ruke u širini ramena i spuštajte telo dok grudi ne dodirnu pod.' },
    { name: 'Čučnjevi', sets: 4, reps: '12-15', description: 'Stojite uspravno sa nogama u širini ramena, spuštajte se dok kolena ne formiraju ugao od 90 stepeni.' },
    { name: 'Trbušnjaci', sets: 3, reps: '15-20', description: 'Ležite na leđima sa savijenim kolenima, podignite gornji deo tela.' },
    { name: 'Istezanje leđa', sets: 2, reps: '30 sec', description: 'Ležite na stomaku, podignite gornji i donji deo tela istovremeno.' },
  ];
